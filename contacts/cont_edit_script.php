...
$query = "update contact set name = '$name', firstname = '$first', adr1 = '$adr1', adr2 = '$adr2', nap = '$nap', city = '$city', teldir = '$teldir', mobile = '$mobile', email= '$email', birthdate = '$birth' where idcont = $idr";
